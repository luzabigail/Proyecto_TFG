...
<head>
  ...
  <link rel="stylesheet" href="assets/css/estilos_libros.css">
...
<body>
  ...
  <nav class="menu" id="menu">
    <?php if (!isset($_SESSION['usuario'])): ?>
      <a class="" href="auth/login.php">Iniciar Sesión</a>
    <?php else: ?>
      <a class="" href="guardados.php">Mis favoritos</a>
      <a class="" href="auth/login.php?logout=1">Cerrar Sesión</a>
    <?php endif; ?>
    <a class="sinopsis.php" href="sinopsis.php">Buscar</a>
    <a class="" href="index.php#recomendaciones">Recomendaciones</a>
  </nav>
